"""
Django settings for tunay project.
...
MIDDLEWARE = [
    ...
    'tunay.portfolio.middleware.PortfolioSuperuserMiddleware',
]

ROOT_URLCONF = 'tunay.urls'
...
WSGI_APPLICATION = 'tunay.wsgi.application'
